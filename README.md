...
```bash
git clone https://github.com/gowrishhp/ci_cd_devops_prototype.git
...
```bash
# Build Docker image
docker buildx build -t gowrishhp/llama:latest .

# Run Docker container
docker run -p 8501:8501 gowrishhp/llama:latest
```
